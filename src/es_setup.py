...
"""Setup Elasticsearch indices with stronger mappings/settings.

Key improvements:
- Custom analyzer (stopwords + stemming + shingles) for scientific text.
- Multi-fields: text + keyword for exact filtering.
- Proper date type for temporal filtering.
- Optional dense_vector fields for hybrid lexical+semantic search.
"""
